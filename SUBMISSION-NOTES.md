...
POST https://synthesis.devfolio.co/register
{
  ...
  "humanInfo": {
    ...
    "socialMediaHandle": "@ghost-clio or the operator handle",
    "background": "builder",
...
## Important Notes
- Submission requires "self-custody transfer" before publishing — check the submission skill for dethe operator
- `moltbookPostURL` is an optional field (post to Moltbook when the operator gives the go-ahead)
